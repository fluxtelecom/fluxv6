...
//print_r($flux_config);exit;
$con=mysqli_connect( $flux_config ['dbhost'],$flux_config ['dbuser'],$flux_config ['dbpass'],$flux_config ['dbname']);
if (mysqli_connect_errno())
  {
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
  }
//mysqli_select_db($flux_config ['dbname']) or die(mysqli_error());
