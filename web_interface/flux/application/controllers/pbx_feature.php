  ...
  function pbx_destination_change($call_type_code="", $did_id="", $extensions=""){
        ...
        if($call_type_code==8)
        {
            ...
            if ($conference->num_rows() > 0) {
                ...
                $conference_info = array("name" => "extensions" ,"id" => "extensions_id", "class" => " extensions_set");
        ...
        if($call_type_code==9)
        {
            $queue = $this->db_model->getSelect( '*' ,'pbx_queue',$whr);
            if ($queue->num_rows() > 0) {
                ...
                $queue_info = array("name" => "extensions" ,"id" => "extensions_id", "class" => " extensions_set");
        ...
        if($call_type_code==10)
        {
            ...
            if ($ivr->num_rows() > 0) {
                ...
                $ivr_info = array("name" => "extensions" ,"id" => "extensions_id", "class" => " extensions_set");
        ...
        if($call_type_code==11)
        {
            ...
            if ($time_condition->num_rows() > 0) {
                ...
                $time_condition_info = array("name" => "extensions" ,"id" => "extensions_id", "class" => " extensions_set");
