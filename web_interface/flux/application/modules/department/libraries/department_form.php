...
function build_department_list_for_admin()
{
    $grid_field_arr = json_encode(array(
        ...
        array(
            ...
            array(
                "EDIT" => array(
                    "url" => "department/department_list_edit/",
                    "mode" => "",
                    "layout" => "medium"
                ),
                "DELETE" => array(
                    "url" => "department/department_remove/",
                    "mode" => "single"
                )
            ),
            "false"
    ...
    function build_department_list_for_admin_old() {        
        ...
        $grid_field_arr = json_encode(array(
	    array(
	    "<input type='checkbox' name='chkAll' class='ace checkall'/><label class='lbl'></label>", "40", "", "", "", "","","false","center"
	    ),
