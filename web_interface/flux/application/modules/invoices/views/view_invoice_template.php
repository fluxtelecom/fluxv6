...
<table class="table">
	...
	<table class="table table-condensed" style="padding: 0;">
		<tr style="width: 100%;">
			...
			<td class="thick-line text-right" style="width: 20%; border-bottom: 1px solid #f5f5f5;"><?php echo $this->common_model->calculate_currency($this->common_model->format_currency($total_amt));?></td>
		</tr>
		 ...
		 <?php if($this_month_recharges > 0){ ?>
			...
			<td style="width: 20%; border-bottom: 1px solid #f5f5f5;"
				class="text-right"><b><?php echo $this->common_model->calculate_currency($this->common_model->format_currency($total_amt));?></b></td>
		</tr>
		<?php } else{?>
			<tr style="width: 100%;">
			<td style="width: 60%; border-bottom: 1px solid #f5f5f5;">&nbsp;</td>
			<td style="width: 20%; border-bottom: 1px solid #f5f5f5;"
				class="text-right"><b><?php echo gettext('Total')?></b></td>
			<td style="width: 15%; border-bottom: 1px solid #f5f5f5;"
				class="text-right"><b><?php echo $this->common_model->format_currency($total_amt);?></b></td>
			</tr>
