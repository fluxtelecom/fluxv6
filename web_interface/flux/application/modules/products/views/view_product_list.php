...
<section class="slice color-three pb-4">
	<div class="w-section inverse p-0">
    	<div class="card col-md-12 pb-4">
        	       ...
        	       <i><b><?php echo gettext("Observação: você não pode excluir um produto que está em uso. Para excluir o produto, você deve liberar esse produto da conta do cliente que está utilizando esse produto ou precisa encerrar o pedido para todos os clientes em utilização.");?></b></i>
        </div>
    </div>
</section>
<? endblock() ?>	
