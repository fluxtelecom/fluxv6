    ...
    function build_orders_list_for_admin()
    {
        $grid_field_arr = json_encode(array(
           /* array(
            ...
            array(
			 gettext("Próxima Data de Cobrança"),
			 "150",
			 "next_billing_date",
			 "next_billing_date",
			 "next_billing_date",
