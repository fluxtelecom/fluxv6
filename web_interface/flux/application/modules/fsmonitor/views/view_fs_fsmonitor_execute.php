...
<section class="slice color-three">
   <div class="w-section inverse p-0">
       ...
       <div class="row">
        ...
        <h3 class="bg-secondary text-light p-2 rounded-top"><?php echo gettext("Switch Commands")?></h3>
        <?php if(($permissioninfo['fsmonitor']['fs_cli']['execute'] == 0  && ($permissioninfo['login_type'] == '-1'))){?>  
         <form method="POST" id="form" name="form" action="<?php echo base_url(); ?>fsmonitor/fs_cli_command/" enctype="multipart/form-data">  
          <div class="col-md-12">
          <div class="row">
            <div class="col-md-5 form-group">
             <label class="col-md-12 control-label p-0"><?php echo gettext("Switch Host:")?></label>
               <select class="col-md-12 form-control form-control-lg selectpicker"  name="host_id" id="host_id">
                ...
                <?php
                  ...
                  <div class="col-md-5 form-group h-auto">
                   <label class="col-md-12 p-0 control-label"><?php echo gettext("Command:")?> </label>
...
<!--                      <button name="action" type="submit" value="save" class="btn btn-success" ><?php echo gettext("Submit")?></button>-->
                      <button type="button" onclick="validateForm();" class="btn btn-success float-right"><?php echo gettext("Execute")?></button>
                 </div>
          </div>
...
<?php } ?>
    ...
    <div class="col-md-12 p-0 mt-4">
      <?php if($command != ''){ ?>
      <div class="col-md-12"><h4 class="alert-dark p-2"><?php echo gettext("Command")?> <font color="blue"><?php echo $command_show; ?></font></h4>
