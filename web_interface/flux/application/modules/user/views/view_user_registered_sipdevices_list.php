...
$(document).ready(function(){ 
  ...
  $.ajax({
	...
	if(!data){
	      window.location.href = "<?php echo base_url();?>user/user_registered_sip_devices/";
	}
    }
   });
});
...
$(document).ready(function(){
 var id="<?php echo $_POST['host_id']?>";
  $("#fs_extension").flexigrid({
    url: "<?php echo base_url();?>user/user_registered_sip_devices_json/"+id,
    method: 'GET',
    dataType: 'json',
	colModel : [
...
<section class="slice color-three">
	<div class="w-section inverse p-0">
		<div id="floating-label" class="card col-md-12 px-0 pb-4">
			<h3 class="bg-secondary text-light p-2 rounded-top"> Registered SIP Devices</h3>
