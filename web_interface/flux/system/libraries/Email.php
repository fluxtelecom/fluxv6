...
var     $smtp_timeout = 500; // SMTP Timeout in seconds
...
/*	var	$useragent		= "CodeIgniter";
	var	$mailpath		= "/usr/sbin/sendmail"; // Sendmail path
	var	$protocol		= "smtp"; // mail/sendmail/smtp
	var	$smtp_host		= "mail.flux.net.br"; // SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= ""; // SMTP Username
	var	$smtp_pass		= ""; // SMTP Password
	var	$smtp_port		= "587"; // SMTP Port
	var	$smtp_timeout = 900; // SMTP Timeout in seconds
	...
	public function print_debugger_email($data = '',$log_path) {
		...
		$shared_file_permission = "chmod -Rf 777  ".$log_path.'flux_email.log';
		$shared_file_permission = system($shared_file_permission, $retval);
		$fp                     = fopen($log_path."flux_email.log", "a+");
		fwrite($fp,$msg);
		fclose($fp);
		return $msg;
	}
