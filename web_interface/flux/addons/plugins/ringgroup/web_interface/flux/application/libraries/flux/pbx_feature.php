...
class pbx_feature {
	function __construct($library_name = '') {
	    ...
	    $this->CI->load->model('Flux_common');
...
//        print_r($data['ivr_controls']);die();
    ...
    function ivr_save($add_array) {
        ...
        if($add_array['id'] == '') {
	        ...
	        return $this->CI->session->set_flashdata('flux_errormsg', 'Ivr added successfully!');
        } else {
...
// print_r($add_array);die();
	        ...
	        return $this->CI->session->set_flashdata('flux_errormsg', 'Ivr updated successfully!');
        }
    }
    ...
    function ivr_delete($ivr_id) {
        ...
        $this->CI->session->set_flashdata('flux_notification', 'Ivr removed successfully!');
        return true;
    }
