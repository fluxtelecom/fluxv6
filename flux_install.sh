...
install_database ()
{
        ...
        mysql -uroot -p${MYSQL_ROOT_PASSWORD} ${FLUX_DATABASE_NAME} < ${FLUX_SOURCE_DIR}/database/flux-6.0.sql
        mysql -uroot -p${MYSQL_ROOT_PASSWORD} ${FLUX_DATABASE_NAME} < ${FLUX_SOURCE_DIR}/database/flux-6.0.1.sql
}
